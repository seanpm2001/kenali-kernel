...
static struct tegra_dc_sd_settings edp_i_1080p_11_6_sd_settings = {
...
static tegra_dc_bl_output edp_i_1080p_11_6_bl_output_measured = {
	0, 1, 2, 3, 4, 5, 6, 7,
...
static int edp_i_1080p_11_6_bl_notify(struct device *unused, int brightness)
{
	...
	if (brightness > 255)
		...
		brightness = edp_i_1080p_11_6_bl_output_measured[brightness];
...
static struct platform_pwm_backlight_data edp_i_1080p_11_6_bl_data = {
	.pwm_id		= 1,
	.max_brightness	= 255,
	.dft_brightness	= 224,
...
static struct platform_device __maybe_unused
		edp_i_1080p_11_6_bl_device = {
	.name	= "pwm-backlight",
	.id	= -1,
	.dev	= {
		.platform_data = &edp_i_1080p_11_6_bl_data,
	},
};

static struct platform_device __maybe_unused
			*edp_i_1080p_11_6_bl_devices[] __initdata = {
	&edp_i_1080p_11_6_bl_device,
};
...
static void edp_i_1080p_11_6_set_disp_device(
	struct platform_device *laguna_display_device)
{
	disp_device = laguna_display_device;
}

static void edp_i_1080p_11_6_dc_out_init(struct tegra_dc_out *dc)
{
	...
	dc->enable = edp_i_1080p_11_6_enable;
	dc->disable = edp_i_1080p_11_6_disable;
	dc->postsuspend	= edp_i_1080p_11_6_postsuspend,
	dc->hotplug_gpio = TEGRA_GPIO_PFF0;
}

static void
edp_i_1080p_11_6_sd_settings_init(struct tegra_dc_sd_settings *settings)
{
	*settings = edp_i_1080p_11_6_sd_settings;
...
struct tegra_panel edp_i_1080p_11_6 = {
	...
	.set_disp_device = edp_i_1080p_11_6_set_disp_device,
};
EXPORT_SYMBOL(edp_i_1080p_11_6);
